 ...
 *
 */
package net.mcreator.manjuproject;
...
@Mod("manju_project")
public class ManjuProjectMod {
	public static final Logger LOGGER = LogManager.getLogger(ManjuProjectMod.class);
	public static final String MODID = "manju_project";
