...
public class ManjuProjectModItems {
	...
	public static final RegistryObject<Item> REIMUDAYON_SPAWN_EGG = REGISTRY.register("reimudayon_spawn_egg", () -> new ForgeSpawnEggItem(ManjuProjectModEntities.REIMUDAYON, -52480, -3407872, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> MAX_TOOL = REGISTRY.register("max_tool", () -> new MaxToolItem());
	public static final RegistryObject<Item> REIMUBOX = block(ManjuProjectModBlocks.REIMUBOX, CreativeModeTab.TAB_TOOLS);
